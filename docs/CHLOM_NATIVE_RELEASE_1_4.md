...
| Authority | Root-administered grants; signed, current, unexpired D3 roles scope privileged calls by module |
...
- Manual weight schedules and benchmark scaffolding do not establish measured production weight certification. Use the exact benchmark evidence and generated weight files if subsequently published.
