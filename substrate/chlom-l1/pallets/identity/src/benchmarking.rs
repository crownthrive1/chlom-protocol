...
mod benchmarks {
    use super::*;
    #[benchmark]
    fn record_identity_version() {
        frame_system::Pallet::<T>::set_block_number(1u32.into());
        assert_ok!(Pallet::<T>::record_identity_version(
            T::AdminOrigin::try_successful_origin().unwrap(),
            id(1),
            1,
            id(2),
            id(3),
        ...
        let origin = T::AdminOrigin::try_successful_origin().expect("benchmark origin");
        #[extrinsic_call]
        _(
            origin,
            id(1),
        ...
        assert_eq!(IdentityHeads::<T>::get(id(1)), Some(2));
    }
    #[benchmark]
    fn record_credential_version() {
        frame_system::Pallet::<T>::set_block_number(1u32.into());
        assert_ok!(Pallet::<T>::record_credential_version(
            T::AdminOrigin::try_successful_origin().unwrap(),
            id(1),
            1,
            id(2),
        ...
        assert_eq!(CredentialHeads::<T>::get(id(1)), Some(2));
    }
