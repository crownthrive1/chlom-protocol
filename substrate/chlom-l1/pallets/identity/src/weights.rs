//! Conservative fallback weights for CHLOM identity.
//!
...
pub trait WeightInfo {
    fn record_identity_version() -> Weight;
    fn record_credential_version() -> Weight;
}

pub struct SubstrateWeight<T>(PhantomData<T>);
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    fn record_identity_version() -> Weight {
        Weight::from_parts(70_000_000, 65_536)
